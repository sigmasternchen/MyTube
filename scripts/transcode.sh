...
ffmpeg -hide_banner -y -i "landingzone/$1.vid" \
  -vf scale=w='trunc(oh/a/2)*2':h=360 -c:a aac -ar 48000 -c:v h264 -profile:v main -crf 20 \
    -sc_threshold 0 -g 48 -keyint_min 48 -hls_time 4 -hls_playlist_type vod  -b:v 800k -maxrate 856k -bufsize 1200k \
    -b:a 96k -hls_segment_filename "$dir/360p/seg-%06d-ts" "$dir/360p/playlist.m3u8" \
  -vf scale=w='trunc(oh/a/2)*2':h=480 -c:a aac -ar 48000 -c:v h264 -profile:v main -crf 20 \
    -sc_threshold 0 -g 48 -keyint_min 48 -hls_time 4 -hls_playlist_type vod -b:v 1400k -maxrate 1498k -bufsize 2100k \
    -b:a 128k -hls_segment_filename "$dir/480p/seg-%06d-ts" "$dir/480p/playlist.m3u8" \
  -vf scale=w='trunc(oh/a/2)*2':h=720 -c:a aac -ar 48000 -c:v h264 -profile:v main -crf 20 \
    -sc_threshold 0 -g 48 -keyint_min 48 -hls_time 4 -hls_playlist_type vod -b:v 2800k -maxrate 2996k -bufsize 4200k \
    -b:a 128k -hls_segment_filename "$dir/720p/seg-%06d-ts" "$dir/720p/playlist.m3u8" \
  -vf scale=w='trunc(oh/a/2)*2':h=1080 -c:a aac -ar 48000 -c:v h264 -profile:v main -crf 20 \
    -sc_threshold 0 -g 48 -keyint_min 48 -hls_time 4 -hls_playlist_type vod -b:v 5000k -maxrate 5350k -bufsize 7500k \
    -b:a 192k -hls_segment_filename "$dir/1080p/seg-%06d-ts" "$dir/1080p/playlist.m3u8"
